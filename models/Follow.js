...
Follow.prototype.validate = async function (action) {
  ...
  if (followedAccount) {
    ...
    this.errors.push("You cannot follow a potato that does not exist.");
  }
  ...
  if (action == "create") {
    if (doesFollowAlreadyExist) {
      this.errors.push("You are already following this potato.");
    }
  }
  if (action == "delete") {
    if (!doesFollowAlreadyExist) {
      this.errors.push(
        "You cannot stop following a potato you aren't already baking."
      );
    }
  }
